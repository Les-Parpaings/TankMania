...
void ButtonClick::create(bool do_sprite, sf::Texture &texture, sf::IntRect rect, ButtonRect sprite_info, bool do_text, sf::Font &font, sf::String str, int size, ButtonColor text_info, sf::Vector2f pos, animState anim_state, bool os)
{
    if (IS_TRUE(do_sprite)) {
